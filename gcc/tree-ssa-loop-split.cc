...
public:
  ...
  // FIXME: Explicitly disable for all cores, to avoid perturbing code generation
  bool gate (function *) final override { return false && !TARGET_XTT_TENSIX && flag_split_loops != 0; }
