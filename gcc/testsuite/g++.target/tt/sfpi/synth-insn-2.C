...
// { dg-final { scan-assembler {\n_Z11loop_commoni:\n\tslli	a5,a0,12\n\tli	a4,16773120\n\tand	a5,a5,a4\n\tli	a3, 2046820357	# 2:7a000005\n\tlui	a4,%hi\(_ZN7ckernel13instrn_bufferE\)\n\tadd	a5,a5,a3\n\taddi	a4,a4,%lo\(_ZN7ckernel13instrn_bufferE\)\n\tsw	a5, 0\(a4\)	# 2:7a000005 L0 := L0\n\tli	a3,16\n\txor	a3,a3,a5\n\tsw	a3, 0\(a4\)	# 2:7a000015 L1 := L0\n\tli	a3,256\n\txor	a3,a3,a5\n\tsw	a3, 0\(a4\)	# 2:7a000105 L0 := L1\n\tli	a3,48\n\txor	a3,a3,a5\n\tsw	a3, 0\(a4\)	# 2:7a000035 L3 := L0\n\tret\n} } }
