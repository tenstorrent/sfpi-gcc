...
**	sw	a5, 0\(a4\)	# 4:SFPSHFT	L3, L0, a5, 0 \| 5
**	addi	a5,a0,1
**	slli	a5,a5,12
**	and	a5,a5,a3
**	add	a5,a5,a2
**	sw	a5, 0\(a4\)	# 2:SFPSHFT	L3, L3, a5, 0 \| 5
**	addi	a5,a0,2
**	slli	a5,a5,12
**	and	a5,a5,a3
**	li	a2, 2046821173	# 8:7a000335
**	add	a5,a5,a2
**	sw	a5, 0\(a4\)	# 8:SFPSHFT	L3, L3, a5, 0 \| 5
**	addi	a5,a0,3
**	slli	a5,a5,12
**	and	a5,a5,a3
**	li	a3, 2046821173	# 6:7a000335
**	add	a5,a5,a3
**	sw	a5, 0\(a4\)	# 6:SFPSHFT	L3, L3, a5, 0 \| 5
**	ret
*/
...
**	li	a3,768
**	xor	a3,a3,a5
**	sw	a3, 0\(a4\)	# 2:SFPSHFT	L3, L0, a3, 0 \| 5
**	sw	a5, 0\(a4\)	# 2:SFPSHFT	L3, L3, a5, 0 \| 5
**	sw	a5, 0\(a4\)	# 2:SFPSHFT	L3, L3, a5, 0 \| 5
**	sw	a5, 0\(a4\)	# 2:SFPSHFT	L3, L3, a5, 0 \| 5
**	ret
