...
void one ()
{
  ...
  __builtin_rvtt_bh_sfpstore (nullptr, r, 0, 0, 0, 0, 0);
}
/*
**_Z3onev:
**	SFPLOAD	L0, 0, 0, 0
...
void two ()
{
  ...
  auto v2 = __builtin_rvtt_bh_sfpload (nullptr, 0, 0, 0, 0, 0);
  auto v3 = __builtin_rvtt_bh_sfpload (nullptr, 0, 0, 0, 0, 0);
  auto v4 = __builtin_rvtt_bh_sfpload (nullptr, 0, 0, 0, 0, 0);
  auto v5 = __builtin_rvtt_bh_sfpload (nullptr, 0, 0, 0, 0, 0);
  auto v6 = __builtin_rvtt_bh_sfpload (nullptr, 0, 0, 0, 0, 0);
