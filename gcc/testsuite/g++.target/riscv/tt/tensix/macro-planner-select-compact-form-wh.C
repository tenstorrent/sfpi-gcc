...
// SETC16 program (regs 19/29/54, sfpi-gcc 2a0ba1e6602) differ.
...
// { dg-final { scan-rtl-dump "Macro-planner descriptor: templates=2 seq=2 misc=0x00000770 setc16=3" "rvtt_macro_planner" } }
