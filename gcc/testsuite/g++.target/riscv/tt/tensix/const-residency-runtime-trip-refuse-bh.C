...
// { dg-final { scan-tree-dump-times "loop-profitability-unproven: strict-positive needs 2 proven trips; 2 materialization words, 0 resident read words, 3 programming words" 2 "rvtt_prgm_const" } }
