...
// The welford-delta restructuring class, RECOGNITION-ONLY: a
// loop-carried FP accumulator (header PHI cycling through sfpadd) is
// licensed reassociation territory in principle, but this pass ships
// no derived restructure -- the candidate refuses BY NAME even under
// the full license, and nothing changes.
