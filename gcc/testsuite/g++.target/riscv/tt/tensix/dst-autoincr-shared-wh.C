...
// A 4-row and a 5-row Wormhole group pay the uniform full cost only through
// the shared dominating program.  The four-word rows exceed the replay
// minimum on this target, so the shared groups are launch-shaped: one
// executing capture plus eight playbacks.
