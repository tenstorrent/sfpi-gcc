// MERGE-RENAME fire (lane KP, FABLE_GOES_BURR R1(b)): an in-loop
...
// { dg-options "-mcpu=tt-wh-tensix -O2 -fno-unroll-loops -mtt-tensix-optimize-const-residency -mtt-tensix-optimize-pressure-park -mtt-tensix-optimize-residency-merge-rename -mtt-tensix-merge-rename-allow-neutral -fdump-tree-rvtt_prgm_const-details" }
...
void merge_rename_fire_wh (void)
{
