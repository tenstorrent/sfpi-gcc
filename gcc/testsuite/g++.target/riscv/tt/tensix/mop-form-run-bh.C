...
// flag builds this leg (the silicon A/B shape).
...
// { dg-final { scan-rtl-dump-times "MOP-form candidate \\(run\\): 8 x launch \\\[0,\\+4\\), config 9 words, modeled benefit -1107" 1 "rvtt_mop_form" } }
// { dg-final { scan-rtl-dump-times "MOP formed \\(mop0-lA-replay, run\\): 8 iterations of launch \\\[0,\\+4\\) -> TTMOP 0, 7, 0" 1 "rvtt_mop_form" } }
