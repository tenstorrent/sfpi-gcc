// { dg-do compile }
// { dg-options "-mcpu=tt-bh-tensix -fno-exceptions -fno-rtti -O2 -fno-unroll-loops -mno-tt-tensix-optimize-replay-hoist -mtt-tensix-optimize-replay-record-hoist -fdump-rtl-rvtt_replay-details" }
// Unguarded half of the legal-domain ordering witness.  The delivery-only
// equation is 4*(492-70)-(615+300) = 773 >= 60, so record-hoist fires.
