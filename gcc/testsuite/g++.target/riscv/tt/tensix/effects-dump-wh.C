...
// { dg-final { scan-assembler-times {# xtt-effects: subunit=store latency=0 lreg-read=0x1 lreg-write=0x0 port=none cc=r config=0x0 rwc=unknown dst=w encodable=yes} 1 } }
