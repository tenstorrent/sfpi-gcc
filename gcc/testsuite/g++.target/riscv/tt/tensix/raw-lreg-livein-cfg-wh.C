...
/* Keep the raw-LREG ownership contract architecture-independent.  This is
   the Wormhole compile counterpart of raw-lreg-livein-cfg-bh.C.  */
void
...
// { dg-final { scan-assembler-times "SFPLOAD\\tL[0234567]," 2 } }
