...
// (6 immediates each).  Control unrolls to 8 replays; the annotated loop
// keeps its in-loop record+launch pair.
// { dg-options "-mcpu=tt-wh-tensix -O2 -fno-unroll-loops -fchecking=2 -mtt-tensix-optimize-invariant-loadi -mtt-tensix-optimize-replay-hoist -mtt-tensix-replay-hoist-min-benefit=0 -fdump-tree-rvtt_invariant-details" }
...
// { dg-final { scan-assembler-times "TTREPLAY" 10 } }
