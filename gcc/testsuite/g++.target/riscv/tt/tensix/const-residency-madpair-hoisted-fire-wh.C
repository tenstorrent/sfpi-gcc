...
// twin.
// { dg-options "-mcpu=tt-wh-tensix -O2 -fno-unroll-loops -mtt-tensix-optimize-const-residency -fdump-tree-rvtt_prgm_const-details" }
...
void madpair_hoisted_fire_wh (void)
{
...
void renamed_saturating_rows_wh (void)
{
