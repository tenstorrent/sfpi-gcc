...
// base = priced-placement-fold-reserve-base-bh.C (BH), same body): the
...
// { dg-options "-mcpu=tt-wh-tensix -O2 -fno-unroll-loops -mtt-tensix-optimize-const-residency -mtt-tensix-optimize-pressure-park -mtt-tensix-optimize-priced-placement -fdump-tree-rvtt_prgm_const-details -fdump-rtl-rvtt_dst_ownership" }
...
#define LD(r) __builtin_rvtt_sfpload (nullptr, (r), 0, 0, 4, 3)
