// WP13 descriptor residency, outward extension FIRE: the WP11 shape
// nested in one further enclosing guarded block loop.  WP11 alone
...
// Word counts are unchanged versus WP11 (no duplication; the fire is
