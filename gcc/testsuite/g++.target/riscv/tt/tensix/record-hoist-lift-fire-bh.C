...
// Record-hoist placement lift, fire side (lane IL; the lcm-fresh
...
// { dg-final { scan-rtl-dump "record-hoist: invariant re-record window admitted .trips 11, words 6, benefit 6187." "rvtt_replay" } }
