...
// A REPLAY word in the tile loop: recorded content is not derivable
// here; refuse by name.
// { dg-final { scan-tree-dump "refused .crossloop-replay-unproven." "rvtt_crossloop" } }
// { dg-final { scan-tree-dump-not "hoisted across" "rvtt_crossloop" } }

#define XLH_TILE_EXTRA() __asm__ __volatile__ (".ttinsn %0" : : "n" (0x04000400))
#define XLH_KERNEL xlh_replay_kernel
