...
// { dg-final { scan-rtl-dump "Hoist pricing .loop \\d+.: trips 32, words 8, exec_ilk 8 slots, deliver_body 984, deliver_record 1107, record 1407, before 984, after 870, benefit 2241 .min 60." "rvtt_replay" } }
...
// The corrected-model fire witness: a delivery-bound counted body (the
// full pricing arithmetic is asserted from the dump above).
void fire_counted ()
{
