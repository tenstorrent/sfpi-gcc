...
// { dg-final { scan-rtl-dump "replay-maximal-repeats: bb \[0-9\]+: 20 symbols in 7 classes, 2 segments, 21 automaton states vs 35 grown sequences; maximal repeats 3 \\(left-maximal 3\\); legacy candidates 6, automaton candidates 6, automaton-only 0, superset OK \\(0 violations\\)" "rvtt_replay" } }
...
void barrier_twin_wh (unsigned n)
{
