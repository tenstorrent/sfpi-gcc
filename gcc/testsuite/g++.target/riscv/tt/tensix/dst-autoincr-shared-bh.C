...
// Two 2-row groups share one dominating slot program: neither pays for the
// three-word configuration alone, together they do.  The non-Dst TTINCRWC
// separator survives untransformed.
// { dg-final { scan-rtl-dump-times "Dst-autoincr group: bb \[0-9\]+ rows 2 stride 2 config 3 words" 1 "rvtt_dst_autoincr" } }
