// bf16-Dst refusal twin: a typed 16-bit-format Dst access (mod0 2,
// FP16B) proves a 16-bit Dst view, in which the SFPSTORE/SFPLOAD
// spill round trip TRUNCATES.  The allocator refuses by name
// (lreg-spill-inexact-dst-mode) and the named pressure error stays.
...
{
  auto a0 = __builtin_rvtt_sfpload (__instrn_buffer, 0, 0, 0, 2, 7);
