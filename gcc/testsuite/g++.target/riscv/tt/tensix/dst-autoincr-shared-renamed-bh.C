...
// { dg-final { scan-rtl-dump-times "Dst-autoincr group: bb \[0-9\]+ rows 3 stride 4 config 3 words" 1 "rvtt_dst_autoincr" } }
// { dg-final { scan-rtl-dump-times "Dst-autoincr group: bb \[0-9\]+ rows 2 stride 4 shared config" 1 "rvtt_dst_autoincr" } }
// { dg-final { scan-assembler-times "TTSETC16\t34, 4" 1 } }
// { dg-final { scan-assembler-not "TTINCRWC\t0, 4, 0, 0" } }
// { dg-final { scan-assembler-times "SFPSTORE\tL., 2, 0, 6" 5 } }
