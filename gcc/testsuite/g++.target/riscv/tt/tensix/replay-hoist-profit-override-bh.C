...
// { dg-final { scan-rtl-dump "Hoist profitable: modeled benefit 19 >= 0" "rvtt_replay" } }
...
// Threshold override: the 3-trip 20-slot shape refused by the cost-table
// default must hoist when -mtt-tensix-replay-hoist-min-benefit=0 lowers the
// experiment threshold below its modeled benefit of 19.
