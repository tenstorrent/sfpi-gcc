...
// Varied stride and row count: ten rows of stride four.
// { dg-final { scan-rtl-dump-times "Dst-autoincr group: bb \[0-9\]+ rows 10 stride 4 config 3 words" 1 "rvtt_dst_autoincr" } }
