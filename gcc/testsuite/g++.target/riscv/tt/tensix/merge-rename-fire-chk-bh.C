...
// { dg-options "-mcpu=tt-bh-tensix -O2 -fno-unroll-loops -mtt-tensix-optimize-const-residency -mtt-tensix-optimize-pressure-park -mtt-tensix-optimize-residency-merge-rename -mtt-tensix-merge-rename-allow-neutral -fchecking -fdump-tree-rvtt_prgm_const-details" }
...
void merge_rename_fire_chk (void)
{
