...
void load_imm () {
    vFloat r = __builtin_rvtt_sfpload (ADDR, 3, 7);
    l_reg[LRegs::LReg3] = r;
}
...
**	li	a5, 1882447872	# 1:7033e000
**	lw	a4,%lo\(_ZN7ckernel13instrn_bufferE\)\(a4\)
**	srli	a0,a0,19
**	add	a0,a0,a5
**	sw	a0, 0\(a4\)	# 1:SFPLOAD	L3, a0, 3, 7
**	# WRITE L3
**	ret
*/
...
void store_imm () {
    ...
    __builtin_rvtt_sfpstore (r.get (), ADDR, 3, 7);
}
...
**	slli	a0,a0,19
**	lui	a4,%hi\(_ZN7ckernel13instrn_bufferE\)
**	li	a5, 1916002304	# 1:7233e000
**	lw	a4,%lo\(_ZN7ckernel13instrn_bufferE\)\(a4\)
**	srli	a0,a0,19
**	add	a0,a0,a5
**	sw	a0, 0\(a4\)	# 1:SFPSTORE	L3, a0, 3, 7
**	ret
*/
