...
test ()
{
  ...
  /* This makes a 25-operation region.  It is deliberately outside the MILP
     scope cap, while the deterministic list scheduler can still move the
     complete chain early and rescue pressure.  */
