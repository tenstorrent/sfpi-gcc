...
// { dg-final { scan-assembler-times {SFPMOV\t.*, L5, 8} 1 } }
...
__attribute__((noinline)) void predicated_select_owned_read_refused ()
{
  vUInt owned = __builtin_rvtt_sfpreadconfig (5);
  __builtin_rvtt_sfpwriteconfig_v (owned.get (), 15);
