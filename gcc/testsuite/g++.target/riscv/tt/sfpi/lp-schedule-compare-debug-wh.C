// { dg-do compile }
// { dg-options "-mcpu=tt-wh-tensix -O2 -fcompare-debug -I [SFPI]/include -fno-exceptions -fno-rtti -mtt-tensix-optimize-pressure-schedule -mtt-tensix-pressure-schedule-use-milp" }
