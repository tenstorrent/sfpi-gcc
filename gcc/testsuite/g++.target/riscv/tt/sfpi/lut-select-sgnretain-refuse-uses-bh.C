...
// Near miss: the tree's selected value has a second consumer besides
// the sign restore, so the un-restored value is still needed.  No
// fold: sign-update mode with the explicit sign copy kept.
