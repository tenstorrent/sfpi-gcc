...
// { dg-final { scan-assembler-times {SFPMOV\t.*, L15, 8} 1 } }
...
__attribute__((noinline)) void predicated_select_disjoint_read ()
{
  vUInt unrelated = __builtin_rvtt_sfpreadconfig (15);
