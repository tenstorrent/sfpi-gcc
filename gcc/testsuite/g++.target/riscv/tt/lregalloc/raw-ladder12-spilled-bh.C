// Hand-spilled same-DAG twin of raw-ladder12-bh.C: at most 8 values
// LREG-resident (a6..a11 parked in scratch Dst rows with exact INT32
// round-trips).  COMPILES TODAY and defines the rung's CRAQ golden:
// any correct exact-only Dst-spilling allocator must make the 12-live
...
#define LSP_NAME ladder12_spilled
#define LSP_N 12
#define LSP_FMT 4
#define LSP_NOINC 7
#define LSP_TRIPS 8
