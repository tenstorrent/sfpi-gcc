// Pressure-ladder rung: exactly 9 simultaneously live vector values
...
// the hand-spilled same-DAG twin ladder9_spilled).
// { dg-do compile }
...
// { dg-final { scan-tree-dump "const-remat: pressure 9 exceeds the 8-LREG file" "rvtt_prgm_const" } }
// { dg-final { scan-tree-dump "lreg-pressure-unresolvable" "rvtt_prgm_const" } }
// { dg-error "lreg-pressure-exceeded" "" { target *-*-* } 0 }

#define LADDER_NAME ladder_live9
#define LADDER_N 9
#define LADDER_FMT 4
