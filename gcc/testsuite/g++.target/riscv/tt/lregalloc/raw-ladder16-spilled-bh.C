// Hand-spilled same-DAG twin of raw-ladder16-bh.C: at most 8 values
// LREG-resident (a6..a15 parked in scratch Dst rows with exact INT32
// round-trips).  COMPILES TODAY and defines the rung's simulator golden:
// any correct exact-only Dst-spilling allocator must make the 16-live
...
#define LSP_NAME ladder16_spilled
#define LSP_N 16
#define LSP_FMT 4
#define LSP_NOINC 7
#define LSP_TRIPS 8
