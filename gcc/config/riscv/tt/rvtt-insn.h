...
RVTT_RTL_ONLY(sfpwrite_lreg0,    -1, -1, 0x48)
RVTT_RTL_ONLY(sfpwrite_lreg1,    -1, -1, 0x48)
RVTT_RTL_ONLY(sfpwrite_lreg2,    -1, -1, 0x48)
RVTT_RTL_ONLY(sfpwrite_lreg3,    -1, -1, 0x48)
RVTT_RTL_ONLY(sfpwrite_lreg4,    -1, -1, 0x48)
RVTT_RTL_ONLY(sfpwrite_lreg5,    -1, -1, 0x48)
RVTT_RTL_ONLY(sfpwrite_lreg6,    -1, -1, 0x48)
RVTT_RTL_ONLY(sfpwrite_lreg7,    -1, -1, 0x48)

RVTT_RTL_ONLY(sfpread_lreg0,      -1, -1, 0x48)
RVTT_RTL_ONLY(sfpread_lreg1,      -1, -1, 0x48)
RVTT_RTL_ONLY(sfpread_lreg2,      -1, -1, 0x48)
RVTT_RTL_ONLY(sfpread_lreg3,      -1, -1, 0x48)
RVTT_RTL_ONLY(sfpread_lreg4,      -1, -1, 0x48)
...
RVTT_BH_BUILTIN (sfpload,         RISCV_V64SF_FTYPE_POINTER_USI_USI_USI_USI_USI,                    0x00, -1,  2, 0x00,  3, 0x1FFF, 0)
RVTT_BH_BUILTIN (sfpload_lv,      RISCV_V64SF_FTYPE_POINTER_V64SF_USI_USI_USI_USI_USI,              0x02, -1,  3, 0x00,  4, 0x1FFF, 0)
...
RVTT_BH_NO_TGT_BUILTIN (sfpstore,       RISCV_VOID_FTYPE_POINTER_V64SF_USI_USI_USI_USI_USI,         0x00, -1,  3, 0x00,  4, 0x1FFF, 0)
