...
RVTT_NO_TGT_BUILTIN_NONSFPU (rocc_noc_fence, RISCV_VOID_FTYPE, 0x01, -1, -1, 0, -1, 0, 0)
RVTT_NO_TGT_BUILTIN_NONSFPU (rocc_dbg_postcode, RISCV_VOID_FTYPE_UDI, 0x01, -1, -1, 0, -1, 0, 0)

#undef RVTT_RTL_ONLY
#undef RVTT_BUILTIN
#undef RVTT_NO_TGT_BUILTIN
#undef RVTT_BUILTIN_NONSFPU
#undef RVTT_NO_TGT_BUILTIN_NONSFPU
