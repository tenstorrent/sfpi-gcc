...
(define_insn "rvtt_wh_sfpload_int"
  [(set (match_operand:V64SF 0 "register_operand" "=x")
        (unspec_volatile [(match_operand:V64SF 1 "reg_or_vec0_operand" "0z")
                          ...
                          (match_operand:SI    3 "const_int_operand" "M02U")
                          (match_operand:SI    4 "const_int_operand" "M14U")] UNSPECV_WH_SFPLOAD_INT))]
  "TARGET_RVTT_WH"
  "SFPLOAD\t%0, %4, %2, %3")
...
(define_insn "rvtt_wh_sfploadi_int"
  [(set (match_operand:V64SF 0 "register_operand" "=x,x")
        (unspec_volatile [(match_operand:V64SF 1 "reg_or_vec0_operand" "0z,0z")
                          ...
                          (match_operand:SI    3 "const_int_operand" "M16S,M16U")] UNSPECV_WH_SFPLOADI_INT))]
  "TARGET_RVTT_WH"
  "@
  SFPLOADI\t%0, %s3, %2
  SFPLOADI\t%0, %u3, %2")
...
(define_insn "rvtt_wh_sfpdivp2_int"
  [(set (match_operand:V64SF 0 "register_operand" "=x")
        (unspec_volatile [(match_operand:V64SF 1 "reg_or_vec0_operand" "0z")
                          ...
                          (match_operand:SI    4 "const_int_operand" "M04U")] UNSPECV_WH_SFPDIVP2_INT))]
  "TARGET_RVTT_WH"
  "SFPDIVP2\t%0, %3, %2, %4"
)
...
(define_insn "rvtt_wh_sfp<wormhole_simple_op_name_int>_int"
  [(set (match_operand:V64SF 0 "register_operand" "=x")
        (unspec_volatile [(match_operand:V64SF 1 "reg_or_vec0_operand" "0z")
                          ...
                          (match_operand:SI    3 "const_int_operand" "M04U")] wormhole_simple_op_int))]
  "TARGET_RVTT_WH"
...
(define_insn "rvtt_wh_sfp<wormhole_muladd_name_int>_int"
  [(set (match_operand:V64SF 0 "register_operand" "=x")
        (unspec_volatile [(match_operand:V64SF 1 "reg_or_vec0_operand" "0z")
                          (match_operand:V64SF 2 "register_operand"  "x")
                          (match_operand:V64SF 3 "register_operand"  "x")
                          (match_operand:SI    4 "const_int_operand" "M04U")] wormhole_muladd_int))]
  "TARGET_RVTT_WH"
...
(define_insn "rvtt_wh_sfpiadd_i_int"
  [(set (match_operand:V64SF 0 "register_operand" "=x")
        (unspec_volatile [(match_operand:V64SF 1 "reg_or_vec0_operand" "0z")
                          ...
                          (match_operand:SI    4 "const_int_operand" "M04U")] UNSPECV_WH_SFPIADD_I_INT))]
  "TARGET_RVTT_WH"
  "SFPIADD\t%0, %2, %3, %4"
)
...
(define_insn "rvtt_wh_sfpnot_int"
  [(set (match_operand:V64SF 0 "register_operand" "=x")
        (unspec_volatile [(match_operand:V64SF 1 "reg_or_vec0_operand" "0z")
                          (match_operand:V64SF 2 "register_operand"  "x")] UNSPECV_WH_SFPNOT_INT))]
  "TARGET_RVTT_WH"
  "SFPNOT\t%0, %2"
)
...
(define_insn "rvtt_wh_sfpcast_int"
  [(set (match_operand:V64SF 0 "register_operand" "=x")
        (unspec_volatile [(match_operand:V64SF 1 "reg_or_vec0_operand" "0z")
                          (match_operand:V64SF 2 "register_operand"  "x")
                          (match_operand:SI    3 "const_int_operand" "M04U")] UNSPECV_WH_SFPCAST_INT))]
  "TARGET_RVTT_WH"
  "SFPCAST %0, %2, %3")
...
(define_insn "rvtt_wh_sfpshft2_e_int"
  [(set (match_operand:V64SF 0 "register_operand" "=x")
        (unspec_volatile [(match_operand:V64SF 1 "reg_or_vec0_operand" "0z")
                          (match_operand:V64SF 2 "register_operand"  "x")
                          (match_operand:SI    3 "const_int_operand" "M04U")] UNSPECV_WH_SFPSHFT2_E_INT))]
  "TARGET_RVTT_WH"
  "SFPSHFT2\t%0, %2, 0, %3")
...
(define_insn "rvtt_wh_sfpstochrnd_i_int"
  [(set (match_operand:V64SF 0 "register_operand" "=x")
        (unspec_volatile [(match_operand:V64SF 1 "reg_or_vec0_operand" "0z")
                          ...
                          (match_operand:SI    3 "immediate_operand" " M05U")
                          (match_operand:V64SF 4 "register_operand"  "x")
                          (match_operand:SI    5 "immediate_operand" "M04U")] UNSPECV_WH_SFPSTOCHRND_I_INT))]
  "TARGET_RVTT_WH"
...
(define_insn "rvtt_wh_sfpstochrnd_v_int"
  [(set (match_operand:V64SF 0 "register_operand" "=x")
        (unspec_volatile [(match_operand:V64SF 1 "reg_or_vec0_operand" "0z")
                          ...
                          (match_operand:V64SF 3 "register_operand"  "x")
                          (match_operand:V64SF 4 "register_operand"  "x")
                          (match_operand:SI    5 "const_int_operand" "M04U")] UNSPECV_WH_SFPSTOCHRND_V_INT))]
  "TARGET_RVTT_WH"
...
(define_insn "rvtt_wh_sfpset<wormhole_set_float_name_i_int>_i_int"
  [(set (match_operand:V64SF 0 "register_operand" "=x")
        (unspec_volatile [(match_operand:V64SF 1 "reg_or_vec0_operand" "0z")
                          ...
                          (match_operand:V64SF 3 "register_operand"  "x")] wormhole_set_float_op_i_int))]
  "TARGET_RVTT_WH"
...
(define_insn "rvtt_wh_sfpsetman_i_int"
  [(set (match_operand:V64SF 0 "register_operand" "=x")
        (unspec_volatile [(match_operand:V64SF 1 "reg_or_vec0_operand" "0z")
                          (match_operand:SI    2 "const_int_operand" "M12U")
                          (match_operand:V64SF 3 "register_operand"  "x")] UNSPECV_WH_SFPSETMAN_I_INT))]
  "TARGET_RVTT_WH"
  "SFPSETMAN\t%0, %3, %2, 1"
)
