...
(define_insn "rvtt_bh_sfpload_int"
  [(set (match_operand:V64SF 0 "register_operand" "=xw,xw")
...
(define_insn "rvtt_bh_sfploadi_int"
  [(set (match_operand:V64SF 0 "register_operand" "=xw,xw,xw,xw")
...
(define_expand "rvtt_bh_sfpstore"
  [(unspec_volatile [(match_operand:SI    0 "address_operand"   "")
                     (match_operand:V64SF 1 "reg_or_readlreg_operand"  "")
                     (match_operand:SI    2 "const_int_operand" "")
                     (match_operand:SI    3 "const_int_operand" "")
                     (match_operand:SI    4 "reg_or_const_int_operand" "")
                     (match_operand:SI    5 "reg_or_0_operand" "")
...
(define_insn "rvtt_bh_sfpstore_int"
  [(unspec_volatile [(match_operand:V64SF 0 "reg_or_readlreg_operand"  "xwxd")
...
(define_expand "rvtt_bh_sfpdivp2"
  [(set (match_operand:V64SF 0 "register_operand" "")
        (unspec_volatile:V64SF [(match_operand:SI    1 "address_operand"  "")
                                ...
                                (match_operand:SI    4 "const_int_operand" "")
                                (match_operand:V64SF 5 "reg_or_readlreg_operand"  "")
...
(define_expand "rvtt_bh_sfpdivp2_lv"
  [(set (match_operand:V64SF 0 "register_operand" "")
        (unspec_volatile:V64SF [(match_operand:SI    1 "address_operand"  "")
                                ...
                                (match_operand:SI    4 "reg_or_0_operand"  "")
                                (match_operand:SI    5 "const_int_operand" "")
                                (match_operand:V64SF 6 "reg_or_readlreg_operand"  "")
...
(define_insn "rvtt_bh_sfpdivp2_int"
  [(set (match_operand:V64SF 0 "register_operand" "=xw,xw")
        (unspec_volatile:V64SF [(match_operand:V64SF 1 "reg_or_vec0_operand" "0,xn")
                                ...
                                (match_operand:V64SF 3 "reg_or_readlreg_operand"  "xrxc,xrxc")
...
(define_expand "rvtt_bh_sfp<blackhole_src_mod_name>"
  [(set (match_operand:V64SF 0 "register_operand" "=xw")
        (unspec_volatile:V64SF [(match_operand:V64SF 1 "reg_or_readlreg_operand"  "xrxc")
...
(define_insn "rvtt_bh_sfp<blackhole_src_mod_name>_lv"
  [(set (match_operand:V64SF 0 "register_operand" "=xw,xw")
        (unspec_volatile:V64SF [(match_operand:V64SF 1 "reg_or_vec0_operand"  "0,xn")
                                (match_operand:V64SF 2 "reg_or_readlreg_operand"  "xrxc,xrxc")
...
(define_insn "rvtt_bh_sfp<blackhole_muladd_name>"
  [(set (match_operand:V64SF 0 "register_operand" "=xw")
        (unspec_volatile:V64SF [(match_operand:V64SF 1 "reg_or_readlreg_operand"  "xrxc")
                                (match_operand:V64SF 2 "reg_or_readlreg_operand"  "xrxc")
...
(define_insn "rvtt_bh_sfp<blackhole_muladd_name>_lv"
  [(set (match_operand:V64SF 0 "register_operand" "=xw")
        (unspec_volatile:V64SF [(match_operand:V64SF 1 "reg_or_vec0_operand" "0")
                                (match_operand:V64SF 2 "reg_or_readlreg_operand"  "xrxc")
                                (match_operand:V64SF 3 "reg_or_readlreg_operand"  "xrxc")
...
(define_expand "rvtt_bh_sfpxiadd_i_lv"
  [(set (match_operand:V64SF 0 "register_operand" "")
        (unspec_volatile:V64SF [(match_operand:SI    1 "address_operand"   "")
                                (match_operand:V64SF 2 "register_operand"  "")
                                (match_operand:V64SF 3 "reg_or_readlreg_operand"  "")
                                (match_operand:SI    4 "reg_or_const_int_operand" "")
                                (match_operand:SI    5 "const_int_operand" "")
...
(define_insn "rvtt_bh_sfpand"
  [(set (match_operand:V64SF 0 "register_operand" "=xw")
        (unspec_volatile:V64SF [(match_operand:V64SF 1 "register_operand"  "0")
                                (match_operand:V64SF 2 "reg_or_readlreg_operand"  "xrxc")] UNSPECV_BH_SFPAND))]
  "TARGET_XTT_TENSIX_BH"
  "SFPAND\t%0, %x2"
)
...
(define_insn "rvtt_bh_sfpor"
  [(set (match_operand:V64SF 0 "register_operand" "=xw")
        (unspec_volatile:V64SF [(match_operand:V64SF 1 "register_operand"  "0")
                                (match_operand:V64SF 2 "reg_or_readlreg_operand"  "xrxc")] UNSPECV_BH_SFPOR))]
  "TARGET_XTT_TENSIX_BH"
  "SFPOR\t%0, %x2"
)
...
(define_insn "rvtt_bh_sfpxor"
  [(set (match_operand:V64SF 0 "register_operand" "=xw")
        (unspec_volatile:V64SF [(match_operand:V64SF 1 "register_operand"  "0")
                                (match_operand:V64SF 2 "reg_or_readlreg_operand"  "xrxc")] UNSPECV_BH_SFPXOR))]
  "TARGET_XTT_TENSIX_BH"
  "SFPXOR\t%0, %x2"
)
...
(define_expand "rvtt_bh_sfpnot"
  [(set (match_operand:V64SF 0 "register_operand" "=xw")
        (unspec_volatile:V64SF [(match_operand:V64SF 1 "reg_or_readlreg_operand"  "xrxc")] UNSPECV_BH_SFPNOT))]
  "TARGET_XTT_TENSIX_BH"
  {
...
(define_insn "rvtt_bh_sfpnot_lv"
  [(set (match_operand:V64SF 0 "register_operand" "=xw,xw")
        (unspec_volatile:V64SF [(match_operand:V64SF 1 "reg_or_vec0_operand"  "0,xn")
                                (match_operand:V64SF 2 "reg_or_readlreg_operand"  "xrxc,xrxc")] UNSPECV_BH_SFPNOT))]
  "TARGET_XTT_TENSIX_BH"
  "SFPNOT\t%0, %x2"
)
...
(define_expand "rvtt_bh_sfpshft2_e"
  [(set (match_operand:V64SF 0 "register_operand" "")
        (unspec_volatile:V64SF [(match_operand:V64SF 1 "reg_or_readlreg_operand"  "")
...
(define_expand "rvtt_bh_sfpstochrnd_i_lv"
  [(set (match_operand:V64SF 0 "register_operand" "")
        (unspec_volatile:V64SF [(match_operand:SI    1 "address_operand"  "")
                                ...
                                (match_operand:V64SF 7 "reg_or_readlreg_operand"  "")
...
(define_insn "rvtt_bh_sfpstochrnd_i_int"
  [(set (match_operand:V64SF 0 "register_operand" "=xw,xw")
        (unspec_volatile:V64SF [(match_operand:V64SF 1 "reg_or_vec0_operand" "0,xn")
                                ...
                                (match_operand:V64SF 4 "reg_or_readlreg_operand"  "xrxc,xrxc")
...
(define_expand "rvtt_bh_sfpstochrnd_v_lv"
  [(set (match_operand:V64SF 0 "register_operand" "")
        (unspec_volatile:V64SF [(match_operand:V64SF 1 "register_operand"  "")
                                (match_operand:SI    2 "const_int_operand" "")
                                (match_operand:V64SF 3 "reg_or_readlreg_operand"  "")
                                (match_operand:V64SF 4 "reg_or_readlreg_operand"  "")
...
(define_insn "rvtt_bh_sfpset<blackhole_set_float_name>_v"
  [(set (match_operand:V64SF 0 "register_operand" "=xw")
        (unspec_volatile:V64SF [(match_operand:V64SF 1 "register_operand"  "0")
                                (match_operand:V64SF 2 "reg_or_readlreg_operand"  "xrxc")] blackhole_set_float_op_v))]
  "TARGET_XTT_TENSIX_BH"
...
(define_expand "rvtt_bh_sfpset<blackhole_set_float_name>_i"
  [(set (match_operand:V64SF 0 "register_operand")
        (unspec_volatile:V64SF [(match_operand:SI    1 "address_operand")
                                ...
                                (match_operand:SI    3 "reg_or_0_operand")
                                (match_operand:SI    4 "const_int_operand")
                                (match_operand:V64SF 5 "reg_or_readlreg_operand")] blackhole_set_float_op_i))]
  "TARGET_XTT_TENSIX_BH"
{
  rtx insn;
...
(define_expand "rvtt_bh_sfpset<blackhole_set_float_name>_i_lv"
  [(set (match_operand:V64SF 0 "register_operand")
        (unspec_volatile:V64SF [(match_operand:SI    1 "address_operand")
                                ...
                                (match_operand:SI    4 "reg_or_0_operand")
                                (match_operand:SI    5 "const_int_operand")
                                (match_operand:V64SF 6 "reg_or_readlreg_operand")] blackhole_set_float_op_i))]
  "TARGET_XTT_TENSIX_BH"
{
  rtx insn;
  if (CONST_INT_P (operands[3]))
...
(define_insn "rvtt_bh_sfpset<blackhole_set_float_name>_i_int"
  [(set (match_operand:V64SF 0 "register_operand" "=xw")
        (unspec_volatile:V64SF [(match_operand:SI    1 "const_int_operand" "N12U")
                                (match_operand:V64SF 2 "reg_or_readlreg_operand"  "xrxc")] blackhole_set_float_op_i))]
  "TARGET_XTT_TENSIX_BH"
...
(define_insn "rvtt_bh_sfpset<blackhole_set_float_name>_i_lv_int"
  [(set (match_operand:V64SF 0 "register_operand" "=xw")
        (unspec_volatile:V64SF [(match_operand:V64SF 1 "register_operand" "0")
                                ...
                                (match_operand:V64SF 3 "reg_or_readlreg_operand"  "xrxc")] blackhole_set_float_op_i))]
  "TARGET_XTT_TENSIX_BH"
...
(define_insn "rvtt_bh_sfpsetman_i_int"
  [(set (match_operand:V64SF 0 "register_operand" "=xw,xw")
        (unspec_volatile:V64SF [(match_operand:V64SF 1 "reg_or_vec0_operand" "0,xn")
                                ...
                                (match_operand:V64SF 3 "reg_or_readlreg_operand"  "xrxc,xrxc")] UNSPECV_BH_SFPSETMAN))]
  "TARGET_XTT_TENSIX_BH"
  "SFPSETMAN\t%0, %x3, %2, 1"
)
...
(define_expand "rvtt_bh_sfpxfcmpv"
  [(set (match_operand:SI 0 "register_operand" "")
        (unspec_volatile:SI [(match_operand:V64SF 1 "reg_or_readlreg_operand"  "")
                             (match_operand:V64SF 2 "reg_or_readlreg_operand"  "")
...
(define_insn "rvtt_bh_sfpswap"
  [(unspec_volatile [(match_operand:V64SF 0 "reg_or_readlreg_operand" "+xrxc")
                     (match_operand:V64SF 1 "reg_or_readlreg_operand" "+xrxc")
