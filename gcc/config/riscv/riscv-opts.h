...
#define TARGET_XTT_TENSIX (bool(TARGET_XTT_TENSIX_WH | TARGET_XTT_TENSIX_BH | TARGET_XTT_TENSIX_QSR))
#define TARGET_XTT_TENSIX_WH_BH (bool(TARGET_XTT_TENSIX_WH | TARGET_XTT_TENSIX_BH))
#define TARGET_XTT_TENSIX_BH_QSR (bool(TARGET_XTT_TENSIX_BH | TARGET_XTT_TENSIX_QSR))
