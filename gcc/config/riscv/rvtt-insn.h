...
RVTT_GS_RTL_ONLY(sfpassignlreg_int,       0x78, 0)
RVTT_GS_RTL_ONLY(sfppreservelreg0_int,    0x78, 0)
RVTT_GS_RTL_ONLY(sfppreservelreg1_int,    0x78, 0)
RVTT_GS_RTL_ONLY(sfppreservelreg2_int,    0x78, 0)
RVTT_GS_RTL_ONLY(sfppreservelreg3_int,    0x78, 0)
...
RVTT_GS_NO_TGT_BUILTIN (sfppreservelreg,RISCV_VOID_FTYPE_V64SF_USI,                                 0x70, -1, -1, 0x00, -1,      0, 0)
...
RVTT_WH_RTL_ONLY(sfpassignlreg_int,       0x78, 0x00)
RVTT_WH_RTL_ONLY(sfppreservelreg0_int,    0x78, 0x00)
RVTT_WH_RTL_ONLY(sfppreservelreg1_int,    0x78, 0x00)
RVTT_WH_RTL_ONLY(sfppreservelreg2_int,    0x78, 0x00)
RVTT_WH_RTL_ONLY(sfppreservelreg3_int,    0x78, 0x00)
RVTT_WH_RTL_ONLY(sfppreservelreg4_int,    0x78, 0x00)
RVTT_WH_RTL_ONLY(sfppreservelreg5_int,    0x78, 0x00)
RVTT_WH_RTL_ONLY(sfppreservelreg6_int,    0x78, 0x00)
RVTT_WH_RTL_ONLY(sfppreservelreg7_int,    0x78, 0x00)
...
RVTT_WH_NO_TGT_BUILTIN (sfppreservelreg,RISCV_VOID_FTYPE_V64SF_USI,                                 0x70, -1, -1, 0x00, -1,      0, 0)
