...
RVTT_BUILTIN (sfpassignlreg,   RISCV_V64SF_FTYPE_USI,                                            0x50, -1, -1, 0x00, -1,      0, 0)
...
RVTT_GS_RTL_ONLY(sfpload_int,             0x08, 0)
RVTT_GS_RTL_ONLY(sfploadi_int,            0x08, 0)
RVTT_GS_RTL_ONLY(sfpstore_int,            0x08, 0)
...
RVTT_GS_RTL_ONLY(sfpassignlreg_int,       0x58, 0)
RVTT_GS_RTL_ONLY(sfppreservelreg0_int,    0x58, 0)
RVTT_GS_RTL_ONLY(sfppreservelreg1_int,    0x58, 0)
RVTT_GS_RTL_ONLY(sfppreservelreg2_int,    0x58, 0)
RVTT_GS_RTL_ONLY(sfppreservelreg3_int,    0x58, 0)
...
RVTT_GS_BUILTIN (sfpload,         RISCV_V64SF_FTYPE_POINTER_USI_USI_USI_USI,                        0x00, -1,  1, 0x00,  2, 0xFFFF, 0)
...
RVTT_GS_NO_TGT_BUILTIN (sfppreservelreg,RISCV_VOID_FTYPE_V64SF_USI,                                 0x50, -1, -1, 0x00, -1,      0, 0)
...
RVTT_GS_NO_TGT_BUILTIN (sfpstore,       RISCV_VOID_FTYPE_POINTER_V64SF_USI_USI_USI_USI,             0x00, -1,  2, 0x00,  3, 0xFFFF, 0)
...
RVTT_WH_RTL_ONLY(sfpassignlreg_int,       0x58, 0x00)
RVTT_WH_RTL_ONLY(sfppreservelreg0_int,    0x58, 0x00)
RVTT_WH_RTL_ONLY(sfppreservelreg1_int,    0x58, 0x00)
RVTT_WH_RTL_ONLY(sfppreservelreg2_int,    0x58, 0x00)
RVTT_WH_RTL_ONLY(sfppreservelreg3_int,    0x58, 0x00)
RVTT_WH_RTL_ONLY(sfppreservelreg4_int,    0x58, 0x00)
RVTT_WH_RTL_ONLY(sfppreservelreg5_int,    0x58, 0x00)
RVTT_WH_RTL_ONLY(sfppreservelreg6_int,    0x58, 0x00)
RVTT_WH_RTL_ONLY(sfppreservelreg7_int,    0x58, 0x00)
...
RVTT_WH_NO_TGT_BUILTIN (sfppreservelreg,RISCV_VOID_FTYPE_V64SF_USI,                                 0x50, -1, -1, 0x00, -1,      0, 0)
