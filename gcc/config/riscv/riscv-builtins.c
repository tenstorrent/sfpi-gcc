...
static const struct riscv_builtin_description riscv_builtins[] = {
  ...
  DIRECT_BUILTIN (sfpmadivv, RISCV_V64SF_FTYPE_USI_V64SF_V64SF_USI,   sfpu),
  DIRECT_BUILTIN (sfpmadviv, RISCV_V64SF_FTYPE_V64SF_USI_V64SF_USI,   sfpu),
  DIRECT_BUILTIN (sfpmadvvi, RISCV_V64SF_FTYPE_V64SF_V64SF_USI_USI,   sfpu),
  DIRECT_BUILTIN (sfpmadiiv, RISCV_V64SF_FTYPE_USI_USI_V64SF_USI,     sfpu),
  DIRECT_BUILTIN (sfpmadvii, RISCV_V64SF_FTYPE_V64SF_USI_USI_USI,     sfpu),
  DIRECT_BUILTIN (sfpmadivi, RISCV_V64SF_FTYPE_USI_V64SF_USI_USI,     sfpu),
  DIRECT_BUILTIN (sfpmadiii, RISCV_V64SF_FTYPE_USI_USI_USI_USI,       sfpu),
