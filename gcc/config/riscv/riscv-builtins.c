...
static const struct riscv_builtin_description riscv_builtins[] = {
  ...
  DIRECT_BUILTIN (sfploadi,   RISCV_V64SF_FTYPE_USI_UHI,               sfpu),
  ...
  DIRECT_BUILTIN (sfpiaddv,   RISCV_V64SF_FTYPE_V64SF_V64SF_USI,       sfpu),
  DIRECT_BUILTIN (sfpiaddi,   RISCV_V64SF_FTYPE_USI_V64SF_USI,         sfpu),
  DIRECT_BUILTIN (sfpshftv,   RISCV_V64SF_FTYPE_V64SF_V64SF_USI,       sfpu),
  DIRECT_BUILTIN (sfpshfti,   RISCV_V64SF_FTYPE_USI_V64SF_USI,         sfpu),
  DIRECT_BUILTIN (sfpabs,     RISCV_V64SF_FTYPE_V64SF_UHI,             sfpu),
  DIRECT_BUILTIN (sfpand,     RISCV_V64SF_FTYPE_V64SF_UHI,             sfpu),
  DIRECT_BUILTIN (sfpor,      RISCV_V64SF_FTYPE_V64SF_UHI,             sfpu),
  DIRECT_BUILTIN (sfpnot,     RISCV_V64SF_FTYPE_V64SF_UHI,             sfpu),
  DIRECT_BUILTIN (sfplz,      RISCV_V64SF_FTYPE_V64SF_UHI,             sfpu),
  DIRECT_BUILTIN (sfpsetexpv, RISCV_V64SF_FTYPE_V64SF_V64SF_USI,       sfpu),
  DIRECT_BUILTIN (sfpsetexpi, RISCV_V64SF_FTYPE_USI_V64SF_USI,         sfpu),
  DIRECT_BUILTIN (sfpsetmanv, RISCV_V64SF_FTYPE_V64SF_V64SF_USI,       sfpu),
  DIRECT_BUILTIN (sfpsetmani, RISCV_V64SF_FTYPE_USI_V64SF_USI,         sfpu),
  DIRECT_BUILTIN (sfpsetsgnv, RISCV_V64SF_FTYPE_V64SF_V64SF_USI,       sfpu),
  DIRECT_BUILTIN (sfpsetsgni, RISCV_V64SF_FTYPE_USI_V64SF_USI,         sfpu),
  DIRECT_BUILTIN (sfpmadvvv,  RISCV_V64SF_FTYPE_V64SF_V64SF_V64SF_USI, sfpu),
  DIRECT_BUILTIN (sfpmadrvv,  RISCV_V64SF_FTYPE_USI_V64SF_V64SF_USI,   sfpu),
  DIRECT_BUILTIN (sfpmadvrv,  RISCV_V64SF_FTYPE_V64SF_USI_V64SF_USI,   sfpu),
  DIRECT_BUILTIN (sfpmadvvr,  RISCV_V64SF_FTYPE_V64SF_V64SF_USI_USI,   sfpu),
  DIRECT_BUILTIN (sfpmadrrv,  RISCV_V64SF_FTYPE_USI_USI_V64SF_USI,     sfpu),
  DIRECT_BUILTIN (sfpmadvrr,  RISCV_V64SF_FTYPE_V64SF_USI_USI_USI,     sfpu),
  DIRECT_BUILTIN (sfpmadrvr,  RISCV_V64SF_FTYPE_USI_V64SF_USI_USI,     sfpu),
  DIRECT_BUILTIN (sfpmadrrr,  RISCV_V64SF_FTYPE_USI_USI_USI_USI,       sfpu),
  ...
  DIRECT_NO_TARGET_BUILTIN (sfpmuli,   RISCV_VOID_FTYPE_USI_V64SF_USI, sfpu),
  DIRECT_NO_TARGET_BUILTIN (sfpaddi,   RISCV_VOID_FTYPE_USI_V64SF_USI, sfpu),
