...
static const struct riscv_builtin_description riscv_builtins[] = {
  ...
  DIRECT_BUILTIN (sfpmuli,    RISCV_V64SF_FTYPE_USI_V64SF_USI,         sfpu),
  DIRECT_BUILTIN (sfpaddi,    RISCV_V64SF_FTYPE_USI_V64SF_USI,         sfpu),
  ...
  DIRECT_BUILTIN (sfpshftv,   RISCV_V64SF_FTYPE_V64SF_V64SF,           sfpu),
  DIRECT_BUILTIN (sfpshfti,   RISCV_V64SF_FTYPE_USI_V64SF,             sfpu),
  ...
  DIRECT_BUILTIN (sfpsetexpv, RISCV_V64SF_FTYPE_V64SF_V64SF,           sfpu),
  DIRECT_BUILTIN (sfpsetexpi, RISCV_V64SF_FTYPE_USI_V64SF,             sfpu),
  DIRECT_BUILTIN (sfpsetmanv, RISCV_V64SF_FTYPE_V64SF_V64SF,           sfpu),
  DIRECT_BUILTIN (sfpsetmani, RISCV_V64SF_FTYPE_USI_V64SF,             sfpu),
  DIRECT_BUILTIN (sfpsetsgnv, RISCV_V64SF_FTYPE_V64SF_V64SF,           sfpu),
  DIRECT_BUILTIN (sfpsetsgni, RISCV_V64SF_FTYPE_USI_V64SF,             sfpu),
