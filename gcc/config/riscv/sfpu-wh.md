...
(define_c_enum "unspecv" [
  ...
  UNSPECV_WH_SFPLOADI_EX
  UNSPECV_WH_SFPLOADI_EX_LV
  ...
  UNSPECV_WH_SFPIADD_V_EX
  UNSPECV_WH_SFPIADD_I
  UNSPECV_WH_SFPIADD_I_LV
  UNSPECV_WH_SFPIADD_I_EX
  UNSPECV_WH_SFPIADD_I_EX_LV
  ...
  UNSPECV_WH_SFPSCMP_EX
  UNSPECV_WH_SFPVCMP_EX
  UNSPECV_WH_SFPENCC
  UNSPECV_WH_SFPCOMPC
  UNSPECV_WH_SFPPUSHC
  UNSPECV_WH_SFPPOPC
...
(define_expand "riscv_wh_sfpassignlr"
  [(set (match_operand:V64SF 0 "register_operand" "")
        (unspec_volatile [(match_operand:SI 1 "immediate_operand" "M")] UNSPECV_WH_SFPASSIGNLR))]
  "TARGET_SFPU_WH"
{
...
(define_expand "riscv_wh_sfpkeepalive"
  [(unspec_volatile [(match_operand:V64SF 0 "register_operand"  "")
                     (match_operand:SI    1 "immediate_operand" "M")] UNSPECV_WH_SFPKEEPALIVE)]
...
(define_insn "riscv_wh_sfpload_int"
  [(set (match_operand:V64SF 0 "register_operand" "=x, x")
        (unspec_volatile [(match_operand:V64SF 1 "nonmemory_operand" "E, 0")
                          ...
                          (match_operand:SI    4 "immediate_operand" "N, N")] UNSPECV_WH_SFPLOAD_INT))]
  "TARGET_SFPU_WH"
  "@
   SFPLOAD\t%0, %2, %3, %4
   SFPLOAD\t%0, %2, %3, %4")
...
(define_expand "riscv_wh_sfploadi_ex"
  [(set (match_operand:V64SF 0 "register_operand" "")
        (unspec [(match_operand:SI 1 "address_operand"  "")
                          (match_operand:SI 2 "immediate_operand" "")
                          (match_operand:SI 3 "nonmemory_operand" "")] UNSPECV_WH_SFPLOADI_EX))]
  "TARGET_SFPU_WH"
{
  rtx live = riscv_sfpu_gen_const0_vector();
  riscv_sfpu_wh_emit_sfploadi_ex(operands[0], live, operands[1], operands[2], operands[3]);
  DONE;
})

(define_expand "riscv_wh_sfploadi_ex_lv"
  [(set (match_operand:V64SF 0 "register_operand" "")
        (unspec [(match_operand:SI    1 "address_operand"   "")
                          (match_operand:V64SF 2 "register_operand"  "")
                          (match_operand:SI    3 "immediate_operand" "")
                          (match_operand:SI    4 "nonmemory_operand" "")] UNSPECV_WH_SFPLOADI_EX_LV))]
  "TARGET_SFPU_WH"
{
  rtx live = operands[2];
  riscv_sfpu_wh_emit_sfploadi_ex(operands[0], live, operands[1], operands[3], operands[4]);
  DONE;
})
...
(define_insn "riscv_wh_sfploadi_int"
  [(set (match_operand:V64SF 0 "register_operand" "=x,x,x,x")
        (unspec_volatile [(match_operand:V64SF 1 "nonmemory_operand" "E,E,0,0")
                          ...
                          (match_operand:SI    3 "immediate_operand" "R,N,R,N")] UNSPECV_WH_SFPLOADI_INT))]
  "TARGET_SFPU_WH"
  "@
  SFPLOADI\t%0, %2, %s3
  SFPLOADI\t%0, %2, %u3
  ...
  "TARGET_SFPU_WH"
{
  if (GET_CODE(operands[3]) == CONST_INT) {
    emit_insn (gen_riscv_wh_sfp<wormhole_muliaddi_name>_int(operands[0], operands[2], operands[3], operands[4]));
  } else {
...
(define_expand "riscv_wh_sfpiadd_v_ex"
  [(set (match_operand:V64SF 0 "register_operand" "=x")
        (unspec_volatile [(match_operand:V64SF 1 "register_operand"  "0")
                          (match_operand:V64SF 2 "register_operand"  "x")
                          (match_operand:SI    3 "immediate_operand" "M")] UNSPECV_WH_SFPIADD_V_EX))]
  "TARGET_SFPU_WH"
{
  riscv_sfpu_wh_emit_sfpiadd_v_ex(operands[0], operands[1], operands[2], operands[3]);
  DONE;
})


(define_expand "riscv_wh_sfpiadd_i_ex"
  [(set (match_operand:V64SF 0 "register_operand" "")
        (unspec_volatile [(match_operand:SI    1 "address_operand"  "")
                          (match_operand:V64SF 2 "register_operand"  "")
                          (match_operand:SI    3 "nonmemory_operand" "")
                          (match_operand:SI    4 "immediate_operand" "")] UNSPECV_WH_SFPIADD_I_EX))]
  "TARGET_SFPU_WH"
{
  rtx live = riscv_sfpu_gen_const0_vector();
  riscv_sfpu_wh_emit_sfpiadd_i_ex(operands[0], live, operands[1], operands[2], operands[3], operands[4]);
  DONE;
})

(define_expand "riscv_wh_sfpiadd_i_ex_lv"
  [(set (match_operand:V64SF 0 "register_operand" "")
        (unspec_volatile [(match_operand:SI    1 "address_operand"   "")
                          (match_operand:V64SF 2 "register_operand"  "")
                          (match_operand:V64SF 3 "register_operand"  "")
                          (match_operand:SI    4 "nonmemory_operand" "")
                          (match_operand:SI    5 "immediate_operand" "")] UNSPECV_WH_SFPIADD_I_EX_LV))]
  "TARGET_SFPU_WH"
{
  rtx live = operands[2];
  riscv_sfpu_wh_emit_sfpiadd_i_ex(operands[0], live, operands[1], operands[3], operands[4], operands[5]);
  DONE;
})
...
(define_insn "riscv_wh_sfpcast_int"
  [(set (match_operand:V64SF 0 "register_operand" "=x, x")
        (unspec_volatile [(match_operand:V64SF 1 "nonmemory_operand" "E, 0")
                          (match_operand:V64SF 2 "register_operand"  "x, x")
                          (match_operand:SI    3 "immediate_operand" "M, M")] UNSPECV_WH_SFPCAST_INT))]
  "TARGET_SFPU_WH"
  "SFPCAST %2 %0 %3")
...
(define_insn "riscv_wh_sfpstochrnd_i_int"
  [(set (match_operand:V64SF 0 "register_operand" "=x, x")
        (unspec_volatile [(match_operand:V64SF 1 "nonmemory_operand" "E, 0")
                          (match_operand:SI    2 "immediate_operand" "P, P") ; XXXX too wide
                          (match_operand:SI    3 "immediate_operand" "P, P")
                          (match_operand:V64SF 4 "register_operand"  "x, x")
                          (match_operand:SI    5 "immediate_operand" "M, M")] UNSPECV_WH_SFPSTOCHRND_I_INT))]
  "TARGET_SFPU_WH"
...
(define_insn "riscv_wh_sfpstochrnd_v_int"
  [(set (match_operand:V64SF 0 "register_operand" "=x")
        (unspec_volatile [(match_operand:V64SF 1 "register_operand"  "0")
                          (match_operand:SI    2 "immediate_operand" "P") ; XXXX too wide
                          (match_operand:V64SF 3 "register_operand"  "x")
                          (match_operand:V64SF 4 "register_operand"  "x")
                          (match_operand:SI    5 "immediate_operand" "M")] UNSPECV_WH_SFPSTOCHRND_V_INT))]
  "TARGET_SFPU_WH"
...
(define_int_iterator wormhole_set_float_op_i [UNSPECV_WH_SFPSETEXP_I UNSPECV_WH_SFPSETMAN_I UNSPECV_WH_SFPSETSGN_I])
(define_int_attr wormhole_set_float_name_i [(UNSPECV_WH_SFPSETEXP_I "exp") (UNSPECV_WH_SFPSETMAN_I "man") (UNSPECV_WH_SFPSETSGN_I "sgn")])
(define_int_attr wormhole_set_float_call_i [(UNSPECV_WH_SFPSETEXP_I "EXP") (UNSPECV_WH_SFPSETMAN_I "MAN") (UNSPECV_WH_SFPSETSGN_I "SGN")])
...
(define_int_iterator wormhole_set_float_op_i_lv [UNSPECV_WH_SFPSETEXP_I_LV UNSPECV_WH_SFPSETMAN_I_LV UNSPECV_WH_SFPSETSGN_I_LV])
(define_int_attr wormhole_set_float_name_i_lv [(UNSPECV_WH_SFPSETEXP_I_LV "exp") (UNSPECV_WH_SFPSETMAN_I_LV "man") (UNSPECV_WH_SFPSETSGN_I_LV "sgn")])
(define_int_attr wormhole_set_float_call_i_lv [(UNSPECV_WH_SFPSETEXP_I_LV "EXP") (UNSPECV_WH_SFPSETMAN_I_LV "MAN") (UNSPECV_WH_SFPSETSGN_I_LV "SGN")])
...
(define_int_iterator wormhole_set_float_op_i_int [UNSPECV_WH_SFPSETEXP_I_INT UNSPECV_WH_SFPSETMAN_I_INT UNSPECV_WH_SFPSETSGN_I_INT])
(define_int_attr wormhole_set_float_name_i_int [(UNSPECV_WH_SFPSETEXP_I_INT "exp") (UNSPECV_WH_SFPSETMAN_I_INT "man") (UNSPECV_WH_SFPSETSGN_I_INT "sgn")])
(define_int_attr wormhole_set_float_call_i_int [(UNSPECV_WH_SFPSETEXP_I_INT "EXP") (UNSPECV_WH_SFPSETMAN_I_INT "MAN") (UNSPECV_WH_SFPSETSGN_I_INT "SGN")])
...
(define_expand "riscv_wh_sfpscmp_ex"
  [(unspec_volatile [(match_operand:SI    0 "address_operand"   "")
                     (match_operand:V64SF 1 "register_operand"  "")
                     (match_operand:SI    2 "nonmemory_operand" "")
                     (match_operand:SI    3 "immediate_operand" "")] UNSPECV_WH_SFPSCMP_EX)]
  "TARGET_SFPU_WH"
{
  riscv_sfpu_wh_emit_sfpscmp_ex(operands[0], operands[1], operands[2], operands[3]);
  DONE;
})

(define_expand "riscv_wh_sfpvcmp_ex"
  [(unspec_volatile [(match_operand:V64SF 0 "register_operand"  "")
                     (match_operand:V64SF 1 "register_operand"  "")
                     (match_operand:SI    2 "immediate_operand" "")] UNSPECV_WH_SFPVCMP_EX)]
  "TARGET_SFPU_WH"
{
  riscv_sfpu_wh_emit_sfpvcmp_ex(operands[0], operands[1], operands[2]);
  DONE;
})
...
(define_insn "riscv_wh_sfpconfig_v"
  [(unspec_volatile [(match_operand:V64SF 0 "register_operand"   "Q0")
                     (match_operand:SI    1 "immediate_operand"  "M")] UNSPECV_WH_SFPCONFIG_V)]
  "TARGET_SFPU_WH"
  "SFPCONFIG\t0, %1, 0")
...
(define_insn "riscv_wh_sfpillegal"
